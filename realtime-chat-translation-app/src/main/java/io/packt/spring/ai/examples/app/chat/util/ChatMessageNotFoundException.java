...
public class ChatMessageNotFoundException extends RuntimeException {
	...
	public static ChatMessageNotFoundException from(UUID chatMessageId) {
		String message = "ChatMessage with ID [%s] not found".formatted(chatMessageId);
		return new ChatMessageNotFoundException(message);
	}
