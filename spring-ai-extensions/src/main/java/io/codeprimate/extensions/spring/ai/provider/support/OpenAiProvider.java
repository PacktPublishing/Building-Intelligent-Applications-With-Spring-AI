...
public class OpenAiProvider implements AiProvider {
	...
	private static final NamedModels NAMED_MODELS = NamedModels.of(
		...
		NamedModel.builder("gpt-4o-search-preview").asChat().asText().withContextWindow(128_000).build(),
		NamedModel.builder("gpt-4o-mini-search-preview").asChat().asText().withContextWindow(128_000).build(),

		NamedModel.builder("o1-preview").asChat().withContextWindow(128_000).build(),
		NamedModel.builder("o1-mini").asChat().withContextWindow(128_000).build(),
