...
/**
 * {@link TextSplitter} returning the entire {@link String text} of the content from the {@link Document}.
 * Therefore, the contents from the {@link Document} is not split and is simply returned as is.
 * <p/>
 * However, this implementation will transform the {@link String content (text)} from the {@link Document}
